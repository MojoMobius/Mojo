...
?>
        ...
        beforeRemoveRow: function (change, source) {
            $.ajax({
                url: '<?php echo Router::url(array('controller' => 'QCValidationRework', 'action' => 'ajaxremoverow')); ?>',
                dataType: 'json',
                type: 'POST',
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?php echo Router::url(array('controller' => 'QCValidationRework', 'action' => 'ajaxsavedatahand')); ?>',
                dataType: 'json',
                type: 'POST',
                data: {changes: change, data: hot.getData()}, // contains changed cells' data
                success: function (result) {
...
//            $("#qc_comments_rowno").val('');
    ...
    hot.addHook('afterChange', function (changes, source) {
        ...
        $.ajax({
            url: '<?php echo Router::url(array('controller' => 'QCValidationRework', 'action' => 'ajaxconvert')); ?>',
            dataType: 'json',
            type: 'POST',
...
<?php ?>
    ...
    $(document).ready(function () {
        ...
        var ProductionEntity = $('#ProductionEntity').val();
        $.ajax({
            url: '<?php echo Router::url(array('controller' => 'QCValidationRework', 'action' => 'ajaxgetdatahand')); ?>',
            dataType: 'json',
            type: 'POST',
            async: false,
