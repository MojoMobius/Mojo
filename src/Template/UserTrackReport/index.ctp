                            ...
                            <table style='width:100%;' class="table table-striped table-center" id='example'>
                                <thead>
                                    ...
                                    <tr class="Heading">
                                        ...
                                        <th class="Cell" width="10%">Client</th> 
                                        <th class="Cell" width="10%">Project</th> 
                                        <th class="Cell" width="10%">Module</th> 
                                        <th class="Cell" width="10%">Id</th>
                                        <th class="Cell" width="10%">Date</th>
                                        <th class="Cell" width="7%">User Name</th>
                                        <th class="Cell" width="7%">Production Hours</th>
                                        <th class="Cell" width="7%">Non Production Hours</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                  ...
                                  //  print_r($Production_dashboard);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!--<input type="checkbox" class="Pri_ids" name="priority[]" id="priority.<?php echo $input['Id']; ?>" value="<?php echo $input['Id'];?>">-->
                                        ...
                                        <td><?php echo $input['ClientName']; ?></td>
                                        <td><?php echo $Projects[$input['ProjectId']]; ?></td>
                                        <td><?php echo $module[$input['ModuleId']]; ?></td>
                                        <td><?php echo $input['DomainId']; ?></td>
                                        <td><?php echo $newDate; ?></td>
                                        <td><?php echo $UserList[$input['UserId']]; ?></td>
                                        <td><?php echo $input['Productiontime']; ?></td>
                                        <td><?php echo $input['NonProductiontime']; ?></td>
...
//        $.ajax({
//            type: "POST",
//            url: "<?php echo Router::url(array('controller' => 'UserTrackReport', 'action' => 'ajaxcengageproject')); ?>",
...
//        }
    ...
    function getStatus(projectId) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller' => 'UserTrackReport', 'action' => 'ajaxstatus')); ?>",
            data: ({projectId: projectId}),
            dataType: 'text',
            async: false,
            success: function (result) {
...
//}
 $(".hotdirectabstraction").html("Loading...");
            $.ajax({
            url: '<?php echo Router::url(array('controller' => 'UserTrackReport', 'action' => 'ajaxdirectabstraction')); ?>',
...
function directabstractionsubmit(){
 ...
 var Proid=$('#ProjectId').val();
            ...
            $.ajax({
            url: '<?php echo Router::url(array('controller' => 'UserTrackReport', 'action' => 'ajaxdirectabstractionsubmit')); ?>',
...
function priority(){
 ...
 $(".hot").html("Loading...");
            $.ajax({
            url: '<?php echo Router::url(array('controller' => 'UserTrackReport', 'action' => 'ajaxgetdata')); ?>',
...
//}
            ...
            $.ajax({
            url: '<?php echo Router::url(array('controller' => 'UserTrackReport', 'action' => 'ajaxgetdatasubmit')); ?>',            
...
function getProject(id){
  ...
  $("#LoadProject").html('Loading...');
            $.ajax({
            url: '<?php echo Router::url(array('controller' => 'UserTrackReport', 'action' => 'ajaxProject')); ?>',
