...
<script>
    ...
    function getJob()
    {
        window.location.href = "GetJobTestModule2?job=newjob";
    }
    ...
    function valicateQuery()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'GetJobTestModule2','action'=>'ajaxqueryposing'));?>",
    ...
    function LoadValue(id, value, toid) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'GetJobTestModule2','action'=>'ajaxloadresult'));?>",
...
$.each( autoArr, function( key, element ) {
        //autoArr.forEach(function (element) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'GetJobTestModule2','action'=>'ajaxautofill'));?>",
    ...
    var j = 0;
        ...
        if (addnew == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'GetJobTestModule2','action'=>'ajaxsave'));?>",
        ...
        if (addnew == 'ADDNEW') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'GetJobTestModule2','action'=>'ajaxnewsave'));?>",
                data: ({productionData_ely: productionData_ely,productionData_projatt: productionData_projatt, productionData: productionData, dynamicData: dynamicData, dynamicData_ely: dynamicData_ely, ProductionEntity: ProductionEntity, SequenceNumber: SequenceNumber, TimeTaken: TimeTaken, RegionId: RegionId}),
                dataType: 'text',
                async: false,
                success: function (result) {
    ...
    document.getElementById('fade').style.display='block';
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'GetJobTestModule2','action'=>'ajaxgetnextpagedata'));?>",
...
//alert(seq);
    ...
    var r = confirm("Are you sure want to delete this page?");
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'GetJobTestModule2','action'=>'ajaxdelete'));?>",
...
var result = new Array();
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'GetJobTestModule2','action'=>'ajaxdatacheck'));?>",
