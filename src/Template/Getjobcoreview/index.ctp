...
?>
    ...
    function getJob()
    {
        window.location.href = "Getjobcoreview?job=newjob";
    }
    ...
    function valicateQuery()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobcoreview','action'=>'ajaxqueryposing'));?>",
    ...
    function LoadValue(id, value, toid) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobcoreview','action'=>'ajaxloadresult'));?>",
...
?>
        ...
        autoArr.forEach(function (element) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjobcoreview','action'=>'ajaxautofill'));?>",
    ...
    document.getElementById('fade').style.display='block';
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobcoreview','action'=>'ajaxgetnextpagedata'));?>",
...
//alert(seq);
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobcore','action'=>'ajaxgetnextpagedata'));?>",
            data: ({page: page, next_status_id: next_status_id, ProductionEntity: ProductionEntity}),
            dataType: 'text',
            async: false,
            success: function (result) {
