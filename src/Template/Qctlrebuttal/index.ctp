...
<div id="detail" class="col-sm-12">
              ...
              <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4>
                               ...
                               <div class="clickview"><a target="_blank" href="<?php echo Router::url(array('controller'=>'Qctlrebuttallist','action'=>'index','PEid' => $data['ProductionEntityID'],'ModuleId'=>$ModuleId));?>" >Click to view</a></div>
                            </h4>
    ...
    <tr><th>Attribute Name</th><th>Attribute Value</th><th>QC Error</th><th>QC Comments</th><th>PU Rebuttal Comments</th><th>PU TL Rebuttal Comments</th><th>Action</th></tr>
...
//                echo "<pre>ss";print_r($data1);exit;
        ?>
         <tr>
             ...
             <td><?php echo $data1['TLReputedComments'];?></td>
             
             <td><div id="button_data_submit_<?php echo $data1['Id'];?>">
             <?php if(($data1['StatusId'] == 6)){ ?>
                <button name="frmsubmit" type="button" onclick="return query('<?php echo $data1['Id'];?>','6','D','<?php echo $data1['QCTLRebuttedComments'];?>','<?php echo $data1['QCComments'];?>','<?php echo $data1['UserReputedComments'];?>','<?php echo $data1['TLReputedComments'];?>','<?php echo $data1['InputEntityId'];?>','<?php echo $data1['ProjectId'];?>','<?php echo $ModuleId;?>');" class="btn btn-default btn-sm added-commnt">Rebute</button>
             <?php }elseif($data1['StatusId'] == 7){?>     
             <button name="frmsubmit" type="button" onclick="return query('<?php echo $data1['Id'];?>','7','D','<?php echo $data1['QCTLRebuttedComments'];?>','<?php echo $data1['QCComments'];?>','<?php echo $data1['UserReputedComments'];?>','<?php echo $data1['TLReputedComments'];?>','<?php echo $data1['InputEntityId'];?>','<?php echo $data1['ProjectId'];?>','<?php echo $ModuleId;?>');" class="btn btn-default btn-sm added-commnt">Reject</button>
             
              <?php }else{ ?>
                  <button name="frmsubmit" type="button" onclick="return query('<?php echo $data1['Id'];?>','6','E','<?php echo $data1['QCTLRebuttedComments'];?>','<?php echo $data1['QCComments'];?>','<?php echo $data1['UserReputedComments'];?>','<?php echo $data1['TLReputedComments'];?>','<?php echo $data1['InputEntityId'];?>','<?php echo $data1['ProjectId'];?>','<?php echo $ModuleId;?>');" class="btn btn-default btn-sm">Rebute</button>
             <button name="frmsubmit" type="button" onclick="return query('<?php echo $data1['Id'];?>','7','E','<?php echo $data1['QCTLRebuttedComments'];?>','<?php echo $data1['QCComments'];?>','<?php echo $data1['UserReputedComments'];?>','<?php echo $data1['TLReputedComments'];?>','<?php echo $data1['InputEntityId'];?>','<?php echo $data1['ProjectId'];?>','<?php echo $ModuleId;?>');" class="btn btn-default btn-sm">Reject</button>
...
<div id="light" class="white_content" style="position:fixed;">
        ...
        <div class="query_innerbdr">
            ...
            ?>
                ...
                <label class="col-sm-4 control-label"><b>QC Error Comments</b></label>
                <div class="col-sm-7">
                    <pre class="" style='background-color:white;border:0px;padding:0px;' id='qcerrortxt'></pre>
                </div>
                
                <label class="col-sm-4 control-label"><b>PU Error Comments</b></label>
                <div class="col-sm-7">
                    <pre class="" style='background-color:white;border:0px;padding:0px;' id='puerrortxt'>-</pre>
                </div>
                
                <label class="col-sm-4 control-label"><b>PU TL Error Comments</b></label>
                <div class="col-sm-7">
                    <pre class="" style='background-color:white;border:0px;padding:0px;' id='putlerrortxt'>-</pre>
                </div>
...
<script type="text/javascript">
 ...
 function query(CommentsId,Status_id,active,tlrebutetxt,qctxt,putxt,putltxt,InputEntityId,ProjectId,ModuleId)
    {
...
function commentsQueryInsert(){
        ...
        var Status_id = $('#Status_id').val();
         ...
         if ($('#QCValueMultiTextbox').val() == '') {
          ...
          $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Qctlrebuttal','action'=>'ajaxpurebutalcommentsinsert'));?>",
