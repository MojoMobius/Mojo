              ...
              <?php } ?></div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label for="inputEmail3" class="col-sm-9 control-label">UrlMonitoring in Progress</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
            ...
            <div id="horizontal" style="height: 100%; width: 100%;">
                <div id="left-pane">
                    <div class="pane-content">
                        ...
                        <div style=""><iframe id="frame" sandbox="" src="<?php echo $FirstLink;?>" style="width:100%; height:430px;margin-top: 10px; overflow:hidden !important;"></iframe>
                        </div> 
                        <!-- Load pdf file ends-->
                    </div>
                </div>
                ...
                <div id="right-pane">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-5 pull-left">
                                <?php  echo $this->Form->input('',array('options' => $Html, 'id'=>'status', 'name' => 'status','style' => 'width: 250px; margin-top:-11px; margin-left:-20px;' ,'class'=>'form-control','onchange' =>'LoadPDF(this.value);')); ?>
                        </div>
                        ...
                        <div class="pull-right" style="cursor:pointer;padding-top:5px;">
                            ...
                            <a class="btn btn-primary btn-xs" href="#InvalidUrlpopup" onclick="OpenInvalidUrl(<?php echo $DomainId ?>, '17');" style="margin-left:5px;">InvalidUrl</a>
                ...
                $i=1;
                 ?>
                        <tr class="Row">
                            ...
                            <td class="Cell"><label style="width:150px; margin-left:7px;" id="InputIdVal" name="InputIdVal"></label></td>
<!--                            <td class="Cell"><label style="width:150px; margin-left:7px;" id="InvalidUrlVal" name="InvalidUrlVal"></label></td>-->
                            <td class="Cell"><textarea style="width:190px; margin-top:7px; margin-bottom:7px; margin-left:7px;" disabled='disabled' id="InvalidUrlVal" name="InvalidUrlVal"></textarea></td>
...
//alert(staticDatavar);
        ...
        if (addnew == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjoburlmonitoring','action'=>'ajaxsave'));?>",
        ...
        if (addnew == 'ADDNEW') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjoburlmonitoring','action'=>'ajaxnewsave'));?>",
    ...
    function loadNextAddnew(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjoburlmonitoring','action'=>'ajaxgetnextpagedata'));?>",
...
//alert(seq);
    ...
    function DeletePage() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjoburlmonitoring','action'=>'ajaxdelete'));?>",
    ...
    function datacheck(id, value) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjoburlmonitoring','action'=>'ajaxdatacheck'));?>",
