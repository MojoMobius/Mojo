...
<div class="container-fluid">
      ...
      <?php //pr($productionjob);?>
                ...
                echo $this->Form->input('', array( 'type'=>'hidden','id' => 'nextPage', 'name' => 'nextPage','value'=>$this->request->params[paging][GetJob][nextPage]));
                ?>
	  <div id="example" class="container-fluid" style="margin-bottom:0px;">
         <div id="vertical">
            <div id="top-pane">
                     ...
                     <div class="pane-content" >
						...
						<div style="margin:10px 0px 5px 0px;">
						  ...
						  <!-- Load pdf file starts -->
                                                  <div style="margin-top:10px;"><iframe id="frame" sandbox="" src="<?php echo $FirstLink;?>" style="width:100%; height:410px; overflow:hidden !important;"></iframe>
						 </div> 
						  <!-- Load pdf file ends-->
						</div>
                   </div>
