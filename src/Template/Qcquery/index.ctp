...
<script type="text/javascript">
    ...
    function getRegion(projectId) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller' => 'Qcquery', 'action' => 'ajaxregion')); ?>",
    ...
    function getModule() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller' => 'Qcquery', 'action' => 'ajaxmodule')); ?>",
    ...
    function getusergroupdetails(RegionId) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller' => 'Qcquery', 'action' => 'getusergroupdetails')); ?>",
            data: ({projectId: ProjectId, regionId: RegionId}),
            dataType: 'text',
            async: false,
            success: function (result) {
    ...
    function getresourcedetails() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller' => 'Qcquery', 'action' => 'getresourcedetails')); ?>",
    ...
    function updateQuery(att, ModuleId, ProductionEntityId) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Qcquery','action'=>'ajaxqueryinsert'));?>",
