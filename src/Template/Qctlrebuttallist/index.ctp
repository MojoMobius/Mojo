...
<!--                                                                 <i id="subgrp-add-field" style="margin-top:5px;" class="fa fa-plus-circle pull-right add-field m-r-10 addSubgrpAttribute" data="<?php echo $keysub; ?>" data-groupId="<?php echo $key; ?>" data-groupName="<?php echo $AttributeSubGroupMasterJSON[$key][$keysub]; ?>"></i> -->
                                                ...
                                                <div style="<?php echo $disnone; ?>Padding:0px;" id="MultiSubGroup_<?php echo $keysub; ?>_<?php echo $grpseq; ?>" class="clearfix">
														...
														?>
																...
																<?php 
//                                                                                                                             echo "<pre>ss";print_r($DependentMasterIds);
//                echo "<pre>ss";print_r($processinputdata);
//                 exit;
...
<!--                                                                <div class="commonClass" id="groupAttr_<?php echo $valprodFields['AttributeMasterId']?>">-->
                                ...
                                echo '<option value="' . $va . '" ' . $sele . '>' . $va . '</option>';
                                  ...
                                  ?>
                                                                    <span style="color:red;float: left;clear:left;"><?php echo $QcErrorComments[$valprodFields['AttributeMasterId']]['seq']['TLReputedComments'][$tempSq]; ?></span>
                              <?php      }  
                                         ?>   
...
<!--                                                                  <div style="cursor: pointer;" id='Error_<?php echo $valprodFields['AttributeMasterId']; ?>' style="margin-left:290px;margin-top: -65px;" value='' onclick="query('<?php echo $valprodFields['DisplayAttributeName'];?>', '<?php echo $valprodFields['AttributeMasterId'];?>', '<?php echo $valprodFields['ProjectAttributeMasterId'];?>', '<?php echo $ProdFieldsValue;?>', '<?php echo $CommentsFieldsValue;?>', '<?php echo $DispositionFieldsValue;?>', '<?php echo $thisseq;?>', '<?php echo $valprodFields['ControlName'];?>');" style="margin-top:-4px;"> 
                            ...
                            <div hide class='qcGreen_popuptitle' id='Error_<?php echo $valprodFields['AttributeMasterId']."_".$tempSq; ?>' style="cursor: pointer; margin-bottom: -9px;display:none;" value='' onclick="query('<?php echo $valprodFields['DisplayAttributeName'];?>', '<?php echo $valprodFields['AttributeMasterId'];?>', '<?php echo $valprodFields['ProjectAttributeMasterId'];?>', '<?php echo $ProdFieldsValue;?>', '<?php echo $CommentsFieldsValue;?>', '<?php echo $DispositionFieldsValue;?>', '<?php echo $tempSq;?>', '<?php echo $valprodFields['ControlName'];?>');">  </div>
                                        <?php }
                            ...
                            <div class='qcRed_popuptitle hide' id='Error_<?php echo $valprodFields['AttributeMasterId']."_".$tempSq; ?>' style="cursor: pointer; margin-bottom: -9px;display:none;" value='' onclick="query('<?php echo $valprodFields['DisplayAttributeName'];?>', '<?php echo $valprodFields['AttributeMasterId'];?>', '<?php echo $valprodFields['ProjectAttributeMasterId'];?>', '<?php echo $ProdFieldsValue;?>', '<?php echo $CommentsFieldsValue;?>', '<?php echo $DispositionFieldsValue;?>', '<?php echo $tempSq;?>', '<?php echo $valprodFields['ControlName'];?>');">  </div>
                                        <?php }
                                        else
                                           {
                                             
                                           ?>
                            <div class='qc_popuptitle hide' id='Error_<?php echo $valprodFields['AttributeMasterId']."_".$tempSq; ?>' style="cursor: pointer; margin-bottom: -9px;display:none;" value='' onclick="query('<?php echo $valprodFields['DisplayAttributeName'];?>', '<?php echo $valprodFields['AttributeMasterId'];?>', '<?php echo $valprodFields['ProjectAttributeMasterId'];?>', '<?php echo $ProdFieldsValue;?>', '<?php echo $CommentsFieldsValue;?>', '<?php echo $DispositionFieldsValue;?>', '<?php echo $tempSq;?>', '<?php echo $valprodFields['ControlName'];?>');">  </div>
                                           <?php
                                           }
                                         ?>
                                                                     <?php if ($isDistinct === false) {
...
<!--                <button type="button" href="#" class="btn btn-default offcanvas__trigger--open" onclick="multipleUrl();" id="multiplelinkbutton" data-rel="page-tag">Multiple Source Links</button>-->
            ...
            <div class="col-lg-6 pull-right m-t-5 m-b-5 hide">		
...
//                    $('#Error_' + AttributeMasterId).addClass("qcGreen_popuptitle");
    ...
    function loadhandsondatafinal(id, idval, key, keysub, submenu,ModuleId) {
        ...
        $.ajax({
            url: '<?php echo Router::url(array('controller' => 'Qctlrebuttallist', 'action' => 'ajaxgetdatahand')); ?>',
            dataType: 'text',
            type: 'POST',
...
function loadhandsondatafinal_all(id, idval, key, keysub,submenu,ModuleId) {
 var ProductionEntityId = $("#ProductionEntity").val();
        ...
        $.ajax({
            url: '<?php echo Router::url(array('controller' => 'Qctlrebuttallist', 'action' => 'ajaxgetdatahandalldata')); ?>',
            dataType: 'text',
            type: 'POST',
