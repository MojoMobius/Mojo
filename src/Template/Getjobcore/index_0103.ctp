                ...
                <div class="page-header p-l-0 p-r-0">
                    <div class="projet-details">
                       ...
                       //pr($StaticFields);
                        $n= 0;
                        ?>
                        <div> <?php foreach ($StaticFields as $key => $value) { ?>

                           <b><?php echo $value['DisplayAttributeName']; ?> </b>: <?php echo $staticFields[$n]['AttributeValue'];?> &nbsp;
              <?php $n++; } ?><br></div>
        ...
        <?php echo $GroupName; ?>
                                        ...
                                        <div class="panel-collapse <?php echo $collapseIn; ?> CampaignWiseMainDiv" data="<?php echo $key; ?>" id="exampleCollapseContinuousOne<?php echo $i; ?>" aria-labelledby="exampleHeadingContinuousOne" role="tabpanel">
                                            ...
                                            <div class="panel-body panel-height">
                                              ...
                                              <!--  <i id="subgrp-add-field" style="top:0px!important;float:left;right:0px;" class="fa fa-plus-circle pull-right add-field m-r-10 addSubgrpAttribute" data="<?php echo $keysub; ?>" data-groupId="<?php echo $key; ?>" data-groupName="<?php echo $AttributeSubGroupMasterJSON[$key][$keysub]; ?>"></i> -->
                                                </div>
                                                ...
                                                <i class="pull-right"><button type="button" class="btn btn-default offcanvas__trigger--close" onclick="loadhandsondatafinal_all('<?php echo $valprodFields['AttributeMasterId']; ?>', '<?php echo $i; ?>', '<?php echo $key; ?>', '<?php echo $keysub; ?>');" data-rel="page-tag" data-target="#exampleFillInHandson" data-toggle="modal">Update</button></i>
                                                                    <?php
                                                                }
                                                                ?>
                                                ...
                                                <div style="<?php echo $disnone; ?>" id="MultiSubGroup_<?php echo $keysub; ?>_<?php echo $grpseq; ?>">
                                                                <?php
                            ...
                            foreach ($valprodFields['Options'] as $ke => $va) {
                                ...
                                if ($ke == $inpValue)
																								$sele = "selected";
                                echo '<option value="' . $ke . '" ' . $sele . '>' . $ke . '</option>';
																						}
																						echo '</select>';
                                                                                    }
                                                                                    ?>
                        ...
                        ?>>A</option>
                                                                ...
                                                                echo 'selected';
                                                                    ...
                                                                    <div>
                                                                            ...
                                                                            ?>
                                                                            <!--<span data-target="#helpmodal"data-toggle="modal" title="Help" onclick='loadHelpContent(<?php echo $valprodFields['AttributeMasterId']; ?>, "<?php echo $valprodFields['DisplayAttributeName']; ?>");' ><img src="img/help_question.png" /></span> -->
                                                                            <i data-target="#helpmodal"data-toggle="modal" title="Help" onclick='loadHelpContent(<?php echo $valprodFields['AttributeMasterId']; ?>, "<?php echo $valprodFields['DisplayAttributeName']; ?>");' class="fa fa-question-circle question" data-target="#branch-info-modal" data-toggle="modal"></i>
                                                                            <!--  ---------------Tool Tip End--------------->
                                                                            <?php } ?>
...
//                                }
        ...
        function loadReferenceUrl() {
            ...
            var groupId = '<?php echo $FirstGroupId; ?>';
            var sequence = 1;
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller' => 'Getjobcore', 'action' => 'ajaxgetgroupurl')); ?>",
                data: ({ProjectId: projectid, RegionId: regionid, InputEntityId: inputentityid, ProdEntityId: prodentityid, groupId: groupId, seq: sequence}),
                dataType: 'text',
                async: true,
                success: function (result) {
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.addSubgrpAttribute').on('click', function () {
            ...
            //maxSeqCnt=1;
            var nxtSeq = parseInt(maxSeqCnt) + 1;
            toappendData = '<div class="multi-field-wrapper"><div class="multi-fields"><hr><font style="color:#62A8EA">Page : <b>' + nxtSeq + '</b></font><br>';
