<!--<script src="https://cdn.jsdelivr.net/npm/handsontable-pro@5.0.2/dist/handsontable.full.min.js"></script>
<link type="text/css" rel="stylesheet" href="https://cdn.jsdelivr.net/npm/handsontable-pro@5.0.2/dist/handsontable.full.min.css">-->
<link data-jsfiddle="common" rel="stylesheet" media="screen" href="webroot/dist/handsontable.css">
<link data-jsfiddle="common" rel="stylesheet" media="screen" href="webroot/dist/handsontable.full.min.css">
...
<script data-jsfiddle="common" src="webroot/dist/handsontable.full.min.js"></script>
...
<!--        <div class="panel m-l-30 m-r-30">
    ...
    <div id="example" class="container-fluid" style="margin-bottom:50px;">
        <div id="workspace">
                <!--<div id="splitter">-->
...
<!--                                        <div class="tab-pane" id="googletab" role="tabpanel">
                            ...
                            <div id="bottomPane" class="keyword_shortlist">
...
<!--                                                           <button class="btn btn-default" onclick="fetchmappings();"  name="fetchmapping" id="fetchmapping" type="button" data-rel="page-tag" data-target="#mappingValues" data-toggle="modal">Fetch Mapping</button>-->
            ...
            <div class="col-lg-6 pull-right m-t-5 m-b-5">		
                <button type="submit" name='Submit' value="saveandexit" class="btn btn-primary pull-right m-r-5" style="<?php echo $style_endisble;?>" onclick="return formSubmit();"> Submit & Exit </button>
                <button type="submit" name='Submit' value="saveandcontinue" class="btn btn-primary pull-right" onclick="return formSubmit();" style="margin-right: 5px;<?php echo $style_endisble;?>"> Submit & Continue </button>
                ...
                success: function (result) {
                    ...
                    if (result != '' && result != null) {
                        ...
                        if (obj['attrinitialhtml'] != '' && obj['attrinitialhtml'] != null) {
                          ...
                          var htmlfileinitial = "https://docs.google.com/viewer?url=http://13.127.184.22/MojoV2htmlfiles/MappingRule_7Seas Bandar Abbas_20180816.xlsx&embedded=true";
...
foreach ($ProductionFields as $key => $val) {
  ...
  $Readonlyfields =  in_array($val['AttributeName'], $ReadonlyFields);
 if($Readonlyfields){
      echo "{readOnly: true},";
 }
else{
    ...
    function fetchmappings()
{
 ...
 $(".loader").show();
        ...
        $.ajax({
            url: '<?php echo Router::url(array('controller' => 'Getjobcore', 'action' => 'ajaxgetmappingvalues')); ?>',
            dataType: 'text',
            type: 'POST',
