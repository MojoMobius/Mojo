                                            ...
                                            <div class="panel-body panel-height subgroupparentdivs subgroupparentdivs_<?php echo $key; ?>" style="border:0px;">
                                                ...
                                                <label class="form-control-label font-weight-400"> <?php echo $AttributeSubGroupMasterJSON[$key][$keysub]; ?></label> 
                                                    ...
                                                    <div class="col-md-6 row-title" style="padding-right: 84px;">
                                                                ...
                                                                ?>
<!--                                                                  <select disabled="disabled" onchange="checkAll(<?php echo $key; ?>,<?php echo $keysub; ?>);" id="subgrp_<?php echo $key; ?>_<?php echo $keysub; ?>" class="subgrp_<?php echo $key; ?>_<?php echo $keysub; ?> pull-right m-l-10 m-r-5 form-control">
                                                                     <option value="">--</option>
                                                ...
                                                <i class="fa fa-info-circle m-r-10 m-l-10 pull-right"  onclick="loadhandsondatafinal_all('<?php echo $valprodFields['AttributeMasterId']; ?>', '<?php echo $i; ?>', '<?php echo $key; ?>', '<?php echo $keysub; ?>');" data-rel="page-tag" data-target="#exampleFillPopup" data-toggle="modal"></i>
                                                                    <?php
                                                                }
                                                                ?>
...
//                                                                                $inpClass = 'onchange="autoSave(' . $valprodFields['AttributeMasterId'] . ', ' . $DependentMasterIds['ProductionField'] . ', ' . $tempSq.');" class="wid-100per form-control doOnBlur ' . $dbClassName . '" ';
                                                            ...
                                                            <div id="MultiField_<?php echo $valprodFields['AttributeMasterId']; ?>_<?php echo $thisseq; ?>" class="clearfix MultiField_<?php echo $valprodFields['AttributeMasterId']; ?> CampaignWiseFieldsDiv_<?php echo $key; ?> row form-responsive" style="<?php echo $disnone; ?>" >
                                                                ...
                                                                <div class="form-group">
                                                                                    ...
                                                                                    if ($inpuControlType == "TextBox") {    
                                                                                        echo '<input type="text" ' . $inpClass . $inpId . $inpName . $inpValue . $inpOnClick . $inpOnBlur . $readonlyRework . $highlightRework . $readonly . '>';
                                                                                    } else if ($inpuControlType == "CheckBox") {
                                                                                        echo '<input type="checkbox" ' . $inpClass . $inpId . $inpName . $inpValue . $inpOnClick . $readonlyRework . $highlightRework . $inpOnBlur .'>';
                                                                                        ...
                                                                                        if(!empty($valprodFields['Options'])){
                                                                                            $inpName = 'name="' . $ProdFieldsName . '[]" ';
                                                                                            $ProdFieldsValueArr=explode(',',$ProdFieldsValue);
                                                                                            echo '<select  ' . $inpClass . $inpId . $disabledRework . $highlightRework . $inpName . $inpOnClick . $inpOnBlur . ' multiple="true">';
                                                                                            foreach ($valprodFields['Options'] as $ke => $va) {
                                                                                            $sele = "";
                                                                                            if (in_array($va,$ProdFieldsValueArr))
                                                                                                $sele = "selected";
                                                                                            ...
                                                                                            echo '<textarea ' . $inpClass . $inpId . $inpName . $readonlyRework . $highlightRework . $inpOnClick . $inpOnBlur .'>'.$ProdFieldsValue.'</textarea>';
                                                                                        }
                                                                                        ...
                                                                                        echo '<input value="Yes" style="position:static"  type="radio" ' . $inpClass . $inpId . $inpName . $inpOnClick . $readonlyRework . $highlightRework . $inpOnBlur . $yesSel . '> Yes  
																	<input style="position:static" value="No" type="radio" ' . $inpClass . $readonlyRework . $highlightRework . $inpId . $inpName . $inpOnClick . $noSel . '> No';
                                                                                    }
                                                                                    else if ($inpuControlType == "DropDownList") {
                                                                                        echo '<select ' . $inpClass . $inpId . $inpName . $disabledRework . $highlightRework . $inpOnClick . $inpOnBlur .'><option value="">--Select--</option>';
                                                                                        if(!empty($valprodFields['Options'])){
                                                                                        foreach ($valprodFields['Options'] as $ke => $va) {
                                                                                            $sele = "";
                              ...
                              <?php      }   
                                         ?>  
                                                                     <select id="reworkCompletedCount_<?php echo $valprodFields['AttributeMasterId'] ?>_<?php echo $tempSq; ?>" style="visibility: hidden" class="attributeWiseQcErrorCount_<?php echo $key; ?>">
                                                                        <option value="<?php echo $QcErrorComments[$valprodFields['AttributeMasterId']]['seq']['StatusID'][$tempSq]; ?>">--</option>
                                                                        </select>
                                                                </div>
                                                                </div>
                                                                <div class="col-md-2 form-text">
                                                                <div class="form-group comments">
                                                                    <textarea <?php echo $readonlyRework; ?> <?php echo $highlightRework; ?> rows="1" cols="50" class="form-control <?php echo $dbClassName_Disposition; ?>" id="<?php echo $CommentsFieldsName; ?>" name="<?php echo $CommentsFieldsName; ?>" placeholder="Comments" onclick="loadWebpage(<?php echo $valprodFields['AttributeMasterId']; ?>, <?php echo $valprodFields['ProjectAttributeMasterId']; ?>, <?php echo $valprodFields['MainGroupId']; ?>, <?php echo $valprodFields['SubGroupId']; ?>,<?php echo $tempSq; ?>, 0);"><?php echo $CommentsFieldsValue; ?></textarea>
                                                                </div>
                                                                </div>
                                                                <div class="col-md-3 form-status">
                                                                <div class="form-group status">
                                                                    <select <?php echo $disabledRework; ?> <?php echo $highlightRework; ?> id="<?php echo $DispositionFieldsName; ?>" name="<?php echo $DispositionFieldsName; ?>"  class="<?php echo $DispositionFieldsName; ?> <?php echo $dbClassName_Disposition; ?> form-control CampaignWiseSelDone_<?php echo $key; ?> dispositionSelect subGrpDisp_<?php echo $key; ?>_<?php echo $keysub; ?>">
                                                                        <option value="">--</option>
                                                                        <option value="A" <?php
                                                                ...
                                                                if (in_array($array1, $array2)) {
                                                                    ?>
                                                                         <i title="Help" class="fa fa-question-circle question" data-target="#helpmodal" data-toggle="modal" onclick='loadHelpContent(<?php echo $valprodFields['AttributeMasterId']; ?>, "<?php echo $valprodFields['DisplayAttributeName']; ?>");'></i>
                ...
                <?php 
                                  ...
                                  ?>
                                                                         ...
                                                                         <div class='qcComments_reject' id='QcCommentsReject_<?php echo $valprodFields['AttributeMasterId']."_".$tempSq; ?>' style="cursor: pointer;"  onclick="QcCommentsReject('<?php echo $valprodFields['AttributeMasterId'];?>', '<?php echo $valprodFields['ProjectAttributeMasterId'];?>','<?php echo $QcErrorComments[$valprodFields['AttributeMasterId']]['seq']['QCComments'][$tempSq];?>','<?php echo $QcErrorComments[$valprodFields['AttributeMasterId']]['seq']['ErrorCategoryName'][$tempSq];?>','<?php echo $tempSq;?>');">  </div>
...
//echo "<pre>s";print_r($list_data_main);exit;
    ...
    <div id="light" class="white_content" style="position:fixed;">
        ...
        <div class="query_innerbdr">
            ...
            ?>
                <label class="col-sm-4 control-label"><b>QC Error</b></label>
                <div class="col-sm-7">
                    <pre class="" style='background-color:white;border:0px;padding:0px;' id='QCError'>-</pre>
                </div>
                ...
                <?php
                  echo $this->Form->button('Rebute', array( 'id' => 'QuerySubmit', 'name' => 'QuerySubmit', 'value' => 'QuerySubmit','class'=>'btn btn-primary btn-sm','onclick'=>"return insertPuRebuttal();",'type'=>'button')).' '; 
                 echo $this->Form->button('Cancel', array( 'type'=>'button','id' => 'Cancel', 'name' => 'Cancel', 'value' => 'Cancel','class'=>'btn btn-primary btn-sm','onclick'=>"document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none';cleartext();")).' '; 
		...
		var pam = element['ProjectAttributeMasterId'];
                ...
                if(element['ControlName']=='RadioButton'){
                   ...
                   if(element['ControlName']=='DropDownList') {
                    ...
                    '<textarea rows="1" cols="50" class="form-control '+dbClass_cmd+'" id="' + commendName + '" name="' + commendName + '" placeholder="Comments"></textarea>' +
                    '</div></div>' +
                    '<div class="col-md-3 form-status"><div class="form-group status">' +
                    '<select id="' + selName + '" name="' + selName + '" class="form-control CampaignWiseSelDone_' + groupId + ' subGrpDisp_'+groupId+'_'+subgrpId+' dispositionSelect '+dbClass_dis+' ' + selName + '">' +
                    '<option value="">--</option>' +
...
//        }
	...
	InputEntityId = $("#InputEntityId").val();
     ...
     var resultcnt = $('#resultcnt').val();
     if (resultcnt != '') {
            alert("Incomplete Records are " + resultcnt + ". Please Accept or Reject!");
            return false;
        } else {
            return true;
        }
...
//        alert("AttributeMasterId_"+AttributeMasterId+'_'+tempSq+'_CopyText_'+COpyTeXt);
    ...
    function qcCommentsAccept(AttributeMasterId, ProjectAttributeMasterId,seq){
        ...
        $('#ProductionFields_'+AttributeMasterId +'_<?php echo $DependentMasterIds['ProductionField']; ?>_'+seq).removeAttr("readonly", "readonly");
        $('#ProductionFields_'+AttributeMasterId +'_<?php echo $DependentMasterIds['ProductionField']; ?>_'+seq).removeAttr("disabled", "disabled");
        $('#ProductionFields_'+AttributeMasterId +'_<?php echo $DependentMasterIds['Comments']; ?>_'+seq).removeAttr("readonly", "readonly");
        $('#ProductionFields_'+AttributeMasterId +'_<?php echo $DependentMasterIds['Disposition']; ?>_'+seq).removeAttr("disabled", "disabled");
      ...
      $("#reworkCompletedCount_"+AttributeMasterId+"_"+seq+" option").val(2);
        Load_totalAttInThisGrpCnt();
    }
    
     function QcCommentsReject(AttributeMasterId, ProjectAttributeMasterId,QcComments,QcError,seq){
     ...
     function insertPuRebuttal(){
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                document.getElementById('PusuccessMessage').style.display = 'block';
                
                setTimeout(function () {
                    document.getElementById('PusuccessMessage').style.display = 'none';
                }, 2000);
            }
        });
        ...
        $('#ProductionFields_'+AttributeMasterId +'_<?php echo $DependentMasterIds['ProductionField']; ?>_'+SequenceNumber).attr("readonly", "readonly");
        $('#ProductionFields_'+AttributeMasterId +'_<?php echo $DependentMasterIds['ProductionField']; ?>_'+SequenceNumber).attr("disabled", "disabled");
        $('#ProductionFields_'+AttributeMasterId +'_<?php echo $DependentMasterIds['Comments']; ?>_'+SequenceNumber).attr("readonly", "readonly");
        $('#ProductionFields_'+AttributeMasterId +'_<?php echo $DependentMasterIds['Disposition']; ?>_'+SequenceNumber).attr("disabled", "disabled");
        
        $("#reworkCompletedCount_"+AttributeMasterId+"_"+SequenceNumber+" option").val(3);
             Load_totalAttInThisGrpCnt();
    }
...
<style>
    ...
    .white_content{display: none;position: absolute;top: 15%;left: 25%;width: 40%;height: auto;padding: 16px;border: 5px solid #fff;z-index:1002; background:url("img/popupbg.png") repeat-x  left top #fdfdfd;}
/*    .query_popuptitle{background:url("img/question.gif") no-repeat left top; margin:0px 30px 10px 0px;}*/
    ...
    .query_popuptitle b,.query_popuptitle1 b, .comment_popuptitle b,.allocation_popuptitle b,.rebute_popuptitle b,.reallocation_popuptitle b{font-size: 12px;text-transform:uppercase;}
