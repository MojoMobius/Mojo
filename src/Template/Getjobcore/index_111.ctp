        ...
        <div class="panel m-l-30 m-r-30">
            <div class="panel-body">
                <div id="splitter">
                        ...
                        <input type="checkbox" class="chk-wid-Url" onClick="ShowUnVerifiedAtt()" id="chk-wid-Url2" value="2" > Show Unverified Fields -->
										 
					<span style="visibility: hidden;">a</span>
					<div style="float: right;">
						<input type="checkbox" class="chk-wid-Url float-right" onclick="ShowUnVerifiedAtt()" id="chk-wid-Url2" value="2"> Show Unverified Fields 
        ...
        <?php echo $GroupName; ?>
                            ...
                            ?>
                                                                ...
                                                                <div class="form-group status">
                                                                    <select id="<?php echo $key.'_'.$keysub.'_'.$valprodFields["AttributeMasterId"].'_'.$tempSq;?>" name="<?php echo $DispositionFieldsName; ?>"  class="<?php echo $dbClassName; ?> form-control CampaignWiseSelDone_<?php echo $key; ?> dispositionSelect">
                                                                        <option value="">--</option>
                                                                        <option value="A" <?php
                ...
                if(phone_number.length){ 
                    ...
                    if(phone_number_value==''){
                        ...
                        if(phone_number_value!=''){
                            ...
                            var isValid = /^\d{3}-\d{3}-\d{4}$/.test(phone_number_value);
                            if (!isValid){
