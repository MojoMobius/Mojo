                    ...
                    <div id="splitter">
                                                    ...
                                                    foreach ($AttributesListGroupWise[$key] as $keysub => $valuesSub) {
                                                        ...
                                                        <div class="panel-body panel-height">
                                                            ...
                                                            if ($keysub != 0) {
                                                                ...
                                                                if ($GroupSeqCnt > 1) {
                                                                    ?>
                                                                    <i class="fa fa-angle-double-right pull-right m-r-5" onclick="Paginate('next', '<?php echo $keysub; ?>', '<?php echo $GroupSeqCnt; ?>');"></i> 
                                                                    <i class="fa fa-angle-double-left pull-right" onclick="Paginate('previous', '<?php echo $keysub; ?>', '<?php echo $GroupSeqCnt; ?>');"></i>
                                                                    <?php
                                                                }
                                                                ?>
                                                                        ...
                                                                        <div class="multi-field-wrapper clearfix"  >
                                                                            <div class="multi-fields">
                                                                                ...
                                                                                for ($thisseq = 1; $thisseq <= $totalSeqCnt; $thisseq++) {
                                                                                    ...
                                                                                    $inpOnClick = 'onclick="loadWebpage(' . $valprodFields['AttributeMasterId'] . ', ' . $valprodFields['ProjectAttributeMasterId'] . ', ' . $valprodFields['MainGroupId'] . ', ' . $valprodFields['SubGroupId'] . ', ' . $tempSq . ', 0);" ';
                                                                                    ?>
                        ...
                        if (in_array($array1, $array2)) {
                            ...
                            <!--                                                                                    <button type="button" id="tooltips" class="tooltips" data-target="#helpmodal" style="margin-top:5px;" data-toggle="modal" title="Help" onclick='loadHelpContent(<?php echo $valprodFields['AttributeMasterId']; ?>, "<?php echo $valprodFields['DisplayAttributeName']; ?>");' >?</button>-->
                                                                                            <span data-target="#helpmodal"data-toggle="modal" title="Help" onclick='loadHelpContent(<?php echo $valprodFields['AttributeMasterId']; ?>, "<?php echo $valprodFields['DisplayAttributeName']; ?>");' ><img src="images/help_question.png" /></span>
                                                                                            <!--  ---------------Tool Tip End--------------->
                        <?php } ?>
    ...
    $(document).ready(function () {
        ...
        $('.addAttribute').on('click', function () {
            ...
            var toappendData = '<div id="MultiField_' + atributeId + '_' + nxtSeq + '" class="multi-field clearfix MultiField_' + atributeId + ' CampaignWiseFieldsDiv_' + groupId + '">' +
                    ...
                    '</select>' +
                    '</div>' +
                    '<i class="fa fa-minus-circle remove-field" data="' + atributeId + '"></i>' +
                    '</div><br>';
        ...
        $('.addSubgrpAttribute').on('click', function () {
            ...
            toappendData += '</div><i class="fa fa-minus-circle removeGroup-field" data="' + subgrpId + '" style="top:0px"></i></div><br>';
            //alert(toappendData);
