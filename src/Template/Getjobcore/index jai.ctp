...
//                                                                                $inpClass = 'onchange="autoSave(' . $valprodFields['AttributeMasterId'] . ', ' . $DependentMasterIds['ProductionField'] . ', ' . $tempSq.');" class="wid-100per form-control doOnBlur ' . $dbClassName . '" ';
                                                            ...
                                                            <div id="MultiField_<?php echo $valprodFields['AttributeMasterId']; ?>_<?php echo $thisseq; ?>" class="clearfix MultiField_<?php echo $valprodFields['AttributeMasterId']; ?> CampaignWiseFieldsDiv_<?php echo $key; ?> row form-responsive" style="<?php echo $disnone; ?>" >
                                                                ...
                                                                <div class="form-group">
                                                                                    ...
                                                                                    if ($inpuControlType == "TextBox") {
                                                                                        echo '<input type="text" ' . $inpClass . $inpId . $inpName . $inpValue . $inpOnClick . $inpOnBlur . '>';
                            ...
                            ?>
                                                                ...
                                                                <div class="form-group status">
                                                                    <select id="<?php echo $key.'_'.$keysub.'_'.$valprodFields["AttributeMasterId"].'_'.$tempSq;?>" name="<?php echo $DispositionFieldsName; ?>"  class="<?php echo $dbClassName_Disposition; ?> form-control CampaignWiseSelDone_<?php echo $key; ?> dispositionSelect">
                                                                        <option value="">--</option>
                                                                        <option value="A" <?php
  ...
  echo "var mandatoryArr = ". $js_array . ";\n";
            ...
            /*var mandatary = 0;
             ...
             return false;
                ...
                if($("#prodInput_4184")){
                    var city_code = $("#prodInput_4184"); //city_code - 209
                }else{
                    var city_code = '';
                }
                if($("#prodInput_4186")){
                    var phone_text = $("#prodInput_4186"); //phone_text - 209
                }else{
                    var phone_text = '';
                }
                if($("#prodInput_3264")){
                    var organization_name = $("#prodInput_3264"); //organization_name - 209
                }else{
...
//                    var city_code = $("#prodInput_2996"); //city_code - 18
//                    var phone_text = $("#prodInput_2998"); //phone_text - 18
//                    var organization_name = $("#prodInput_2971"); //organization_name - 18
                    
                    
                    
                    if(organization_name.length){
                        var organization_name_value = organization_name.val();
                        if(organization_name_value==''){
                          alert("Organization Name shouldn't be empty");
                          organization_name.focus();
                          organization_name.addClass('text-danger');
                          return false;
                        }
                        if (organization_name_value.match(/^\s\s*/)){
                          alert('Remove Preceding white space in Organization name');
                          organization_name.focus();
                          organization_name.addClass('text-danger');
                          return false;
                          }
                        if(organization_name_value.match(/\s\s*$/)){
                          alert('Remove Trailing white space in Organization name');
                          organization_name.focus();
                          organization_name.addClass('text-danger');
                          return false;
                      }
                      if(organization_name_value.match(/  +/g)){
                         alert('Remove More than one white space in Organization name');
                         organization_name.focus();
                         organization_name.addClass('text-danger');
                         return false;
                      }
                      if(organization_name_value.length > 100){
                         alert("Organization name shouldn't be exceeds more than 100 charcters");
                         organization_name.focus();
                         organization_name.addClass('text-danger');
                         return false;
                       }
                    ...
                    alert('Remove Preceding white space in Mailing street');
                    mailing_street.focus();
                    mailing_street.addClass('text-danger');
                    return false;
                }
                if(mailing_street_value.match(/\s\s*$/)){
                    alert('Remove Trailing white space in Mailing street');
                    mailing_street.focus();
                    mailing_street.addClass('text-danger');
                    return false;
                }
                if(mailing_street_value.match(/  +/g)){
                   alert('Remove More than one white space in Mailing street');
                    mailing_street.focus();
                    mailing_street.addClass('text-danger');
                    return false;
                }
...
//                }
        ...
        if(physical_street.length){ 
                    ...
                    alert('Remove Preceding white space in Physical street');
                    physical_street.focus();
                    physical_street.addClass('text-danger');
                    return false;
                }
                if(physical_street_value.match(/\s\s*$/)){
                    alert('Remove Trailing white space in Physical street');
                    physical_street.focus();
                    physical_street.addClass('text-danger');
                    return false;
                }
                if(physical_street_value.match(/  +/g)){
                   alert('Remove More than one white space in Physical street');
                    physical_street.focus();
                    physical_street.addClass('text-danger');
                    return false;
                }
                if(physical_street_value!=''){
                    physical_street_value_replaced = physical_street_value.replace(/#/g , ", No.");
                    physical_street.val(physical_street_value_replaced);
                }
                var mailing_street_value = mailing_street.val();
                     var physical_street_value = physical_street.val();
//                    if (mailing_street_value =='' && physical_street_value !='') {
...
//                }
        ...
        if(physical_Postal1.length){ 
                ...
                if(physical_country_value=='australia'){
                    ...
                    /* if(first_name.length && typeof first_name !== "undefined"){
                    ...
                    phone_type_value = phone_type_value.toLowerCase();
                        if(phone_type_value!=''){
                            if(phone_type_value!='toll-free' && phone_type_value!='fax' && phone_type_value!='phone'){
                                alert("Invalid phone type");
                                phone_type.focus();
                                phone_type.addClass('text-danger');
                                return false;
                            }
                        }
                    }
                    ...
                    var physical_country_value = physical_country.val();
                    physical_country_value = physical_country_value.toLowerCase();
                    var phone_type_value = phone_type.val();
                    phone_type_value = phone_type_value.toLowerCase();
                    if(area_code_value==''){
                        if(physical_country_value=='united states' || physical_country_value=='canada'){
                                alert("Area code shouldn't be empty");
                                area_code.focus();
                                area_code.addClass('text-danger');
                                return false; 
                        }
                    }
                    if(area_code_value!=''){
                        var string = area_code_value;
                            var myRegEx  = /[^0-9\d]/i;
                        ...
                        if(area_code_value.length > 3){
                             alert("Area code shouldn't be exceeds more than 3 digits");
                             area_code.focus();
                             area_code.addClass('text-danger');
                             return false;
                           }
                       if(area_code_value=='800' && area_code_value=='855' && area_code_value=='866' && area_code_value=='877' && area_code_value=='888'){
                            var phone_type_value_replace ='Toll-free';
                            phone_type.val(phone_type_value_replace);
                        }
                        if(physical_country_value!='united states' && physical_country_value!='canada'){
                        area_code.val('');
                        }
                    ...
                    if(country_calling_code_value!=''){
                        if(area_code_value!=''){
                            alert("Country calling code should be left as blank since area code was filled.");
                ...
                if(city_code.length){
                    ...
                    if(city_code_value!=''){
                        if(area_code_value!=''){
                            alert("City code should be left as blank since area code was filled.");
                            city_code.focus();
                            city_code.addClass('text-danger');
                            return false;
                        }
                    }
                    if(city_code_value==''){
                        if(physical_country_value!='us' && physical_country_value!='united states' && physical_country_value!='canada'){
                            if((area_code_value!='800' && area_code_value!='855' && area_code_value!='866' && area_code_value!='888')||(phone_type_value!='toll-free' && phone_type_value!='fax')){
                                alert("City code shouldn't be empty");
                                city_code.focus();
                                city_code.addClass('text-danger');
                                return false; 
                            }
                    ...
                    if(city_code_value!=''){
                     ...
                     var city_code_zero_replaced = city_code_value.replace(/^0+/, '');
                     city_code.val(city_code_zero_replaced);
                    }
                }
                if(phone_number.length){ 
                    var phone_number_value = phone_number.val();
                    var phone_text_value = phone_text.val();
                    var phone_type_value = phone_type.val();
                    var area_code_value = area_code.val();
                    phone_type_value = phone_type_value.toLowerCase();
                    var physical_country_value = physical_country.val();
                    ...
                    if(phone_number_value==''){
                        ...
                        if(phone_number_value!=''){
                            if(phone_type_value=='toll-free'){
                            var string = phone_number_value;
                            var myRegEx  = /[^a-z\d]/i;
                            var isValid = !(myRegEx.test(string));                           
                            if(isValid)
                            {
                                if(string.length > 15)
                                {
                                    alert('Invalid Toll-free number');
                                     phone_number.focus();
                                     phone_number.addClass('text-danger');
                                     return false;
                            ...
                            if(physical_country_value=='united states'){
                            var isValid = /^\d{3}-\d{4}$/.test(phone_number_value);
                            if (!isValid){
                            ...
                            }else if(physical_country_value=='canada'){
                            var isValid = /^\d{3}-\d{4}$/.test(phone_number_value);
                            if (!isValid){
                            alert('Invalid Phone number');
                            phone_number.focus();
                            ...
                            }else if(physical_country_value=='australia'){
                            var isValid = /^\d{4}-\d{4}$/.test(phone_number_value);
                            if (!isValid){
                            alert('Invalid Phone number');
                            phone_number.focus();
                            phone_number.addClass('text-danger');
                            ...
                            }else if(physical_country_value=='india'){
                            var isValid = /^\d{4}-\d{4}$/.test(phone_number_value);
                            if (!isValid){
                            alert('Invalid Phone number');
                            phone_number.focus();
                            ...
                            if(isValid)
                            {
                                ...
                                if(result.length > 15)
                                {
                                 ...
                                 alert('Invalid Phone number.Numbers & hypen are only allowed');
                                 phone_number.focus();
                                 phone_number.addClass('text-danger');
                                 return false;
                            }
...
//                    var organization_name = $("#prodInput_3264"); //organization_name - 209
                    ...
                    if(organization_name.length){
                        ...
                        if(organization_name_value==""){
                          alert("Organization Name shouldn't be empty");
                          setTimeout(function(){organization_name.focus();}, 10);
                          organization_name.addClass('text-danger');
                          return false;
                        }
                        if (organization_name_value.match(/^\s\s*/)){
                    ...
                    if(mailing_street.length){
                        mailing_street.blur(function() {
                    var mailing_street_value = mailing_street.val();
                    if (mailing_street_value.match(/^\s\s*/)){
                    alert('Remove Preceding white space in Mailing street');
                    setTimeout(function(){mailing_street.focus();}, 10);
                    mailing_street.addClass('text-danger');
                    return false;
                }
                if(mailing_street_value.match(/\s\s*$/)){
...
//                }
        ...
        if(mailing_city.length){
            mailing_city.blur(function() {
                ...
                if (mailing_street_value !='' && mailing_city_value=='') {
                        alert("Mailing city shouldn't be empty");
                        setTimeout(function(){mailing_city.focus();}, 10);
                        mailing_city.addClass('text-danger');
                        return false;
                    }
                    if (mailing_city_value.match(/\d+/g)){
        ...
        if(mailing_state.length){
            mailing_state.blur(function() {
                ...
                var mailing_street_value = mailing_street.val();
                    ...
                    if (mailing_street_value !='' && mailing_state_value=='') {
                        alert("Mailing state shouldn't be empty");
                        //setTimeout(function(){mailing_state.focus();}, 10);
                        mailing_state.focus();
                        mailing_state.addClass('text-danger');
                        return false;
                    }
        ...
        if(mailing_country.length){
            mailing_country.blur(function() {
                ...
                var mailing_city_value = mailing_city.val();
                    ...
                    if (mailing_street_value !='' && mailing_country_value=='') {
                        alert("Mailing country shouldn't be empty");
                        //setTimeout(function(){mailing_country.focus();}, 10);
                        mailing_country.focus();
                        mailing_country.addClass('text-danger');
                        return false;
                    }
        ...
        if(Mailing_Postal1.length){
            Mailing_Postal1.blur(function() {
                ...
                if (mailing_street_value =='' && Mailing_Postal1_value!='') {
                    ...
                    if (mailing_street_value !='' && Mailing_Postal1_value=='') {
                        alert("Mailing Postal shouldn't be empty");
                        setTimeout(function(){Mailing_Postal1.focus();}, 10);
                        Mailing_Postal1.addClass('text-danger');
                        return false;
                    }
                if (mailing_country_value !='' && Mailing_Postal1_value=='') {
        ...
        if(physical_street.length){ 
            physical_street.blur(function() {
                     var physical_street_value = physical_street.val();
                    if (physical_street_value =='') {
                        alert("Physical street shouldn't be empty");
                        setTimeout(function(){physical_street.focus();}, 10);
                        physical_street.addClass('text-danger');
                        return false;
                    }
                    if (physical_street_value.match(/^\s\s*/)){
...
//                }
                ...
                if (physical_street_value !='' && physical_city_value=='') {
                        alert("Physical city shouldn't be empty");
                        setTimeout(function(){physical_city.focus();}, 10);
                        physical_city.addClass('text-danger');
                        return false;
                    }
                    if (physical_city_value.match(/\d+/g)){
        ...
        if(physical_state.length){
            physical_state.blur(function() {
                ...
                var physical_street_value = physical_street.val();
                    ...
                    if (physical_street_value !='' && physical_state_value=='') {
                        alert("Physical state shouldn't be empty");
                        //setTimeout(function(){physical_state.focus();}, 10);
                        physical_state.focus();
                        physical_state.addClass('text-danger');
                        return false;
                    }
        ...
        if(physical_country.length){
            physical_country.blur(function() {
                var physical_country_value = physical_country.val();
                var physical_street_value = physical_street.val();
                var physical_city_value = physical_city.val();
                    if (physical_street_value =='' && physical_country_value!='') {
                    ...
                    if (physical_street_value !='' && physical_country_value=='') {
                        alert("Physical country shouldn't be empty");
                        //setTimeout(function(){physical_country.focus();}, 10);
                        physical_state.focus();
                        physical_country.addClass('text-danger');
                        return false;
                    }
        ...
        if(physical_Postal1.length){ 
            physical_Postal1.blur(function() {
                var physical_Postal1_value = physical_Postal1.val();
                var physical_country_value = physical_country.val();
                var physical_street_value = physical_street.val();
                if (physical_street_value =='' && physical_Postal1_value!='') {
                    ...
                    if (physical_street_value !='' && physical_Postal1_value=='') {
                        alert("Physical Postal shouldn't be empty");
                        setTimeout(function(){physical_Postal1.focus();}, 10);
                        physical_Postal1.addClass('text-danger');
                        return false;
                    }
                if (physical_country_value !='' && physical_Postal1_value=='') {
                ...
                if(physical_country_value=='australia'){
                    ...
                    /* if(first_name.length && typeof first_name !== "undefined"){
                     ...
                     if(first_name_value!=''){
                         ...
                         if(first_name_status_value=='m'){
                          alert("First Name status shouldn't be as M");
                          setTimeout(function(){first_name_status.focus();}, 10);
                          first_name_status.addClass('text-danger');
                          return false;
                        }
                      }
                    ...
                    /* if(last_name.length){
                     ...
                     if(last_name_value!=''){
                         if(last_name_status_value=='m'){
                          alert("Last Name status shouldn't be as M");
                          setTimeout(function(){last_name_status.focus();}, 10);
                          last_name_status.addClass('text-danger');
                          return false;
                        }
                      }
                    ...
                    if(phone_type.length){
                        phone_type.blur(function() {
                    var phone_type_value = phone_type.val();
                    phone_type_value = phone_type_value.toLowerCase();
                        if(phone_type_value!=''){
                            if(phone_type_value!='toll-free' && phone_type_value!='fax' && phone_type_value!='phone'){
                                alert("Invalid phone type");
                                setTimeout(function(){phone_type.focus();}, 10);
                                phone_type.addClass('text-danger');
                                return false;
                            }
                        }
                    ...
                    if(area_code_value==''){
                        if(physical_country_value=='united states' || physical_country_value=='canada'){
                                alert("Area code shouldn't be empty");
                                setTimeout(function(){area_code.focus();}, 10);
                                area_code.addClass('text-danger');
                                return false; 
                        }
                    }
                    ...
                    if(country_calling_code.length){
                        country_calling_code.blur(function() {
                    var country_calling_code_value = country_calling_code.val();
                    var phone_number_value = phone_number.val();
                    var physical_country_value = physical_country.val();
                    var physical_country_value = physical_country_value.toLowerCase();
                    ...
                    if(country_calling_code_value!=''){
                        if(area_code_value!=''){
                            alert("Country calling code should be left as blank since area code was filled.");
                           setTimeout(function(){country_calling_code.focus();}, 10);
                            country_calling_code.addClass('text-danger');
                            return false;
                        }
                    }
                    ...
                    if(country_calling_code_value!=''){
                        if(phone_number_value==''){
                            alert("Phone number shouldn't be empty");
                            setTimeout(function(){phone_number.focus();}, 10);
                            phone_number.addClass('text-danger');
                            return false;
                        }
                    }
                ...
                if(city_code.length){
                    ...
                    if(city_code_value!=''){
                        if(area_code_value!=''){
                            alert("City code should be left as blank since area code was filled.");
                            setTimeout(function(){city_code.focus();}, 10);
                            city_code.addClass('text-danger');
                            return false;
                        }
                    }
    ...
    $(document).ready(function () {
        ...
        $('.addAttribute').on('click', function () {
           ...
           element=[];
             ...
             var inpId = 'ProductionField_' + atributeId + '_<?php echo $DependentMasterIds['ProductionField']; ?>_' + nxtSeq;
		...
		var pam = element['ProjectAttributeMasterId'];
                     ...
                     if(elementValidate['ControlName']=='TextBox'){
                         inpOnBlur =' onblur="'+mandateFunction+elementValidate['FunctionName']+'(this.id, this.value,'+'\''+elementValidate['AllowedCharacter'] + '\', '+'\''+elementValidate['NotAllowedCharacter']+'\', '+'\''+elementValidate['Dateformat']+'\', '+'\''+elementValidate['AllowedDecimalPoint']+'\');" maxlength="'+elementValidate['MaxLength']+'" minlength="'+elementValidate['MinLength']+'"';   
                     ...
                     }else if(elementValidate['ControlName']=='MultiTextBox'){
                         inpOnBlur =' onblur="'+mandateFunction+elementValidate['FunctionName']+'(this.id, this.value,'+'\''+elementValidate['AllowedCharacter'] + '\', '+'\''+elementValidate['NotAllowedCharacter']+'\', '+'\''+elementValidate['Dateformat']+'\', '+'\''+elementValidate['AllowedDecimalPoint']+'\');"';   
                     }
                        //alert(inpOnBlur);
                        //onblur="NumbersOnly(this.id, this.value,'', '', '', 'null');" maxlength="null" minlength="null"
                    if(element['ControlName']=='TextBox')
                        toappendData +='<input '+inpOnBlur+' type="text" class="wid-100per form-control doOnBlur '+dbClass+'" id="' + inpId + '" '" name="' + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);">' ;
                    if(element['ControlName']=='MultiTextBox'){
                        if(element['Options'] != ''){
                             toappendData +='<select '+inpOnBlur+' class="wid-100per form-control doOnBlur '+dbClass+'"  id="' + inpId + '" name="' + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);"><option value="">--Select--</option>';
                      ...
                      toappendData +='</select>';
                        ...
                        toappendData +='<textarea '+inpOnBlur+' class="wid-100per form-control doOnBlur '+dbClass+'" id="' + inpId + '" name="' + inpName + '"  onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);"></textarea>' ;
                    }
                    }
                if(element['ControlName']=='CheckBox')
                        toappendData +='<input '+inpOnBlur+' type="checkbox" class="doOnBlur '+dbClass+'" id="' + inpId + '" name="' + inpName + '"  onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);">' ;  
                if(element['ControlName']=='RadioButton'){
                        toappendData +='<input value="Yes" type="radio" style="position:static" class="doOnBlur '+dbClass+'" id="' + inpId + '" name="' + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);"> Yes '+
                                        '<input value="No" type="radio" style="position:static" class="doOnBlur '+dbClass+'" id="' + inpId + '" name="' + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);"> No ' ;  
                            }
                   if(element['ControlName']=='DropDownList') {
                        toappendData +='<select '+inpOnBlur+' class="wid-100per form-control doOnBlur '+dbClass+'"  id="' + inpId + '" + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);"><option value="">--Select--</option>';
                    ...
                    '<select '+inpOnBlur+' id="" name="' + selName + '" class="form-control CampaignWiseSelDone_' + groupId + ' dispositionSelect '+dbClass_dis+'">' +
                    '<option value="">--</option>' +
            ...
            $.each(subGrpAttArr, function (key, element) {
			   ...
			   if(element['ControlName']=='MultiTextBox')
                ...
                toappendData +='<textarea '+inpOnBlur+' class="wid-100per form-control doOnBlur '+dbClass+'" id="' + inpId + '" name="' + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);"></textarea>' ;
                        ...
                        toappendData +='<input '+inpOnBlur+' type="checkbox" class="doOnBlur '+dbClass+'" id="' + inpId + '" name="' + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);">' ;  
                if(element['ControlName']=='RadioButton'){
                        toappendData +='<input '+inpOnBlur+' value="Yes" type="radio" style="position:static"  class="doOnBlur InsertFields" id="' + inpId + '" name="' + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);"> Yes '+
                                        '<input '+inpOnBlur+' value="No" type="radio" style="position:static"  class="doOnBlur InsertFields" id="' + inpId + '" name="' + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);"> No ' ;  
                            }
                   if(element['ControlName']=='DropDownList') {
                        toappendData +='<select '+inpOnBlur+' class="wid-100per form-control doOnBlur '+dbClass+'"  id="' + inpId + '" name="' + inpName + '" onclick="getThisId(this);loadWebpage('+atributeId+', '+pam+', '+groupId+', '+subgrpId+', '+nxtSeq+', 0);"><option value="">--Select--</option>';
