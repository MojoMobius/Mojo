            ...
            <div class="panel-heading" role="tab" id="headingTwo">
                <h3 class="panel-title">
                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="text-decoration:none;">
                        ...
                        <button type="button" name='AddNew' value="AddNew" class="btn btn-primary
                                btn-xs pull-right" style="margin-right:3px;" onclick="addnewpage();">Add New</button>
                        <button type="button" name='Save' value="Save" class="btn btn-primary
                                btn-xs pull-right" onclick="AjaxSave();">Save</button>
...
<!--                                <input id="1390" class="form-control" size="40" name="1390" value="" onblur="('1390', this.value, '', '', '', '')" maxlength="" minlength="" type="text">-->
                                 <?php if($value['ControlName']=='TextBox' || $value['ControlName']=='Label') { ?>
                                        ...
                                        <!--
                                        <select class="form-control" name="<?php echo $value['AttributeMasterId']; ?>" id="<?php echo $value['AttributeMasterId']; ?>">
                                        ...
                                        <textarea title="<?php echo $value['AttributeValue'];?>"  name="<?php echo $value['AttributeMasterId']; ?>" id="<?php echo $value['AttributeMasterId']; ?>" onblur="<?php echo $value['FunctionName'];?>('CommonPAM[<?php echo $value['ProjectAttributeMasterId'];?>]', this.value, '<?php echo $value['AllowedCharacter'];?>', '<?php echo $value['NotAllowedCharacter'];?>')"><?php echo $dynamicData[$value['AttributeValue']];?></textarea>
                    ...
                    <div class="pane-content">
                        ...
                        <div style="margin:10px 0px 5px 0px;">
                            ...
                            <div class="pull-right" style="margin-bottom:10px">
                                <a  class="btn btn-primary btn-xs pull-right" href="#InvalidUrlpopup" onclick="OpenInvalidUrl(<?php echo $FirstLinkId ?>,'17');" style="margin-left:5px;">InvalidUrl</a>
                                <button class="btn btn-primary btn-xs " name='gopdf' id='gopdf' onclick="OpenPdf();">Go</button>
                                <button class="btn btn-primary btn-xs " name='pdfPopUP' id='pdfPopUp' onclick="PdfPopup();">Undock</button>
                            </div>
                        </div>
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group mar" style="margin-left:10px;">
                            ...
                            <input type="text" class="form-control" size="40"  name="<?php echo $value['AttributeMasterId']; ?>" id="<?php echo $value['AttributeMasterId']; ?>" value="<?php echo $productionjob[$value['AttributeMasterId']];?>" onblur="<?php echo $value['FunctionName'];?>('<?php echo $value['AttributeMasterId'];?>', this.value, '<?php echo $value['AllowedCharacter'];?>', '<?php echo $value['NotAllowedCharacter'];?>', '<?php echo $value['Dateformat'];?>', '<?php echo $value['AllowedDecimalPoint'];?>')" maxlength="<?php echo $value['MaxLength'];?>" minlength="<?php echo $value['MinLength'];?>">
                                                    <?php } elseif($value['ControlName']=='DropDownList') { ?>
                            <select class="form-control"  name="<?php echo $value['AttributeMasterId']; ?>" id="<?php echo 'test'.$value['ProjectAttributeMasterId']; ?>" value="<?php echo $productionjob[$value['AttributeMasterId']];?>" onblur="<?php echo $value['FunctionName'];?>('<?php echo $value['AttributeMasterId'];?>', this.value, '<?php echo $value['AllowedCharacter'];?>', '<?php echo $value['NotAllowedCharacter'];?>', '<?php echo $value['Dateformat'];?>', '<?php echo $value['AllowedDecimalPoint'];?>')" onchange="<?php echo $value['Reload'];?>" >
                                <option value="0">--select--</option>
                                                    <?php foreach($value['Options'] as $key_opt=>$opt) { ?>
        ...
        <div class="popup">
            ...
            <div class="content">
                ...
                $i=1;
                 ?>
                <tr class="Row">
                    <td class="Cell"><?php echo $i;?><input type="hidden" name="ProjectId" id="ProjectId" value="<?php echo $productionjob['ProjectId'];?>">
                        <input type="hidden" name="InputEntityId" id="InputEntityId" value="<?php echo $productionjob['InputEntityId'];?>">
                        <input type="hidden" name="RegionId" id="RegionId" value="<?php echo $productionjob['RegionId'];?>">
                        <input type="hidden" name="UsrID" id="UsrID" value="<?php echo $productionjob['UserId'];?>">
                        <input type="hidden" name="DomainId" id="DomainId" value="<?php echo $FirstLinkId ?>">
...
<!--                    <td class="Cell"><label id="InputIdVal" name="InputIdVal"></label></td>
                ...
                <div class="col-sm-10" align="center">
                    <button class="btn btn-warning" value="updateInvalidUrl" name='updateInvalidUrl'  id='updateInvalidUrl' onclick = "return valicateValidInvalid('17');">Submit</button>
                </div>
            </div>
        </div>
    </div>
...
?>
        var mandatary = 0;
      $.each( mandatoryArr, function( key, element ) {  
    ...
    function getJob()
    {
        window.location.href = "Getjoburlproduction?job=newjob";
    }
    ...
    function valicateQuery()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjoburlproduction','action'=>'ajaxqueryposing'));?>",
    ...
    function LoadValue(id, value, toid) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjoburlproduction','action'=>'ajaxloadresult'));?>",
...
$.each( autoArr, function( key, element ) {
        //autoArr.forEach(function (element) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjoburlproduction','action'=>'ajaxautofill'));?>",
    ...
    var j = 0;
        ...
        if (addnew == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjoburlproduction','action'=>'ajaxsave'));?>",
        ...
        if (addnew == 'ADDNEW') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjoburlproduction','action'=>'ajaxnewsave'));?>",
                data: ({productionData_ely: productionData_ely,productionData_projatt: productionData_projatt, productionData: productionData, dynamicData: dynamicData, dynamicData_ely: dynamicData_ely, ProductionEntity: ProductionEntity, SequenceNumber: SequenceNumber, TimeTaken: TimeTaken, RegionId: RegionId}),
                dataType: 'text',
                async: false,
                success: function (result) {
    ...
    document.getElementById('fade').style.display='block';
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjoburlproduction','action'=>'ajaxgetnextpagedata'));?>",
...
//alert(seq);
    ...
    var r = confirm("Are you sure want to delete this page?");
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjoburlproduction','action'=>'ajaxdelete'));?>",
...
var result = new Array();
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjoburlproduction','action'=>'ajaxdatacheck'));?>",
    ...
    function OpenInvalidUrl(value,others)
    {
        ...
        $.ajax({
            ...
            data: ({DomainUrl:str,DomainId:DomainId,RegionId:Region}),
            dataType: 'text',
            async: false,
            success: function (result) {
...
//        });    
    ...
    function valicateValidInvalid(chkval)
    {
        ...
        $.ajax({
            ...
            data: ({ProjectId:ProjectId,RegionId:RegionId,UrlId:UrlId,Remarks:Remarks,Reason:Reason,UserId:UserId}),
            dataType: 'text',
            async: false,
            success: function (result) {
                document.getElementById('successMessage').style.display = 'block';
