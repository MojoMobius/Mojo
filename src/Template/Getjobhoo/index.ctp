                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label for="inputEmail3" class="col-sm-9
                                       control-label">HOO Production in Progress</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="pane-content" style="width:99.7%;" >
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-6
                                   ...
                                   <input type="hidden" name="CommonAM[<?php echo $value['ProjectAttributeMasterId'];?>]" id="<?php //echo $value['AttributeMasterId']; ?>"  value="<?php echo $dynamicData[$value['AttributeMasterId']];?>">
                    ...
                    <div class="form-inline">
                            ...
                            foreach ($ReadOnlyFields as $key => $value) {
                                ...
                                ?>
                                    ...
                                    <input type="text" class="form-control" size="40" disabled="" id="<?php echo $value['AttributeMasterId']; ?>"  value="<?php echo $productionjob[$value['AttributeMasterId']];?>"  >
...
<script>
    ...
    function getJob()
    {
        window.location.href = "Getjobhoo?job=newjob";
    }
    ...
    function valicateQuery()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobhoo','action'=>'ajaxqueryposing'));?>",
    ...
    function LoadValue(id, value, toid) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobhoo','action'=>'ajaxloadresult'));?>",
...
$.each( autoArr, function( key, element ) {
        //autoArr.forEach(function (element) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjobhoo','action'=>'ajaxautofill'));?>",
    ...
    var j = 0;
        ...
        if (addnew == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjobhoo','action'=>'ajaxsave'));?>",
        ...
        if (addnew == 'ADDNEW') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjobhoo','action'=>'ajaxnewsave'));?>",
                data: ({productionData_ely: productionData_ely,productionData_projatt: productionData_projatt, productionData: productionData, dynamicData: dynamicData, dynamicData_ely: dynamicData_ely, ProductionEntity: ProductionEntity, SequenceNumber: SequenceNumber, TimeTaken: TimeTaken, RegionId: RegionId}),
                dataType: 'text',
                async: false,
                success: function (result) {
    ...
    document.getElementById('fade').style.display='block';
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobhoo','action'=>'ajaxgetnextpagedata'));?>",
            ...
            success: function (result) {
               ...
               // prodArr.forEach(function (element) {
                ...
                $.each( readonlyArr, function( key, element ) { 
               // readonlyArr.forEach(function (element) {
                    var elt = element['AttributeMasterId'];
                    $('#' + elt).val(resultData[elt]);
...
//alert(seq);
    ...
    var r = confirm("Are you sure want to delete this page?");
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobhoo','action'=>'ajaxdelete'));?>",
...
var result = new Array();
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobcore','action'=>'ajaxdatacheck'));?>",
