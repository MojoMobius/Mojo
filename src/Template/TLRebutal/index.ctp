                                    ...
                                    <tbody> 
                                        <?php $i = 0;
                                            foreach ($Production_batch as $inputVal => $input):
                                                $TLRebutalDetails = $this->Html->link('TLRebutal_Details', ['action' => 'checkdetails',$input['Id'],$input['ProjectId'],$input['RegionId'],$input['ProcessId']]);
                                        ?>
                                        <tr><?php if($input['StatusId'] == '2'){
                                            ...
                                            <td><?php echo $TLRebutalDetails; ?></td>
                                        </tr>
                                        <?php $i++; endforeach; ?>
                                    </tbody>
                                </table>
...
<script>
    ...
    function getRegion(projectId) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller' => 'TLRebutal', 'action' => 'ajaxregion')); ?>",
    ...
    function getModule()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller' => 'TLRebutal', 'action' => 'ajaxmodule')); ?>",
            data: ({ProjectId: ProjectId}),
            dataType: 'text',
            async: false,
            success: function (result) {
    ...
    function getusergroupdetails(RegionId) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller' => 'TLRebutal', 'action' => 'getusergroupdetails')); ?>",
...
//        $.ajax({
//            type: "POST",
//            url: "<?php echo Router::url(array('controller' => 'TLRebutal', 'action' => 'getresourcedetails')); ?>",
