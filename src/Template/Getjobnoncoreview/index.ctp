               ...
               <div class="col-md-2">
                  <div class="form-group">
                     <label for="inputEmail3" class="col-sm-6
                            control-label" style="white-space:nowrap;"><b>Non Core process</b></label>
                     <div class="col-sm-6">
                        &nbsp;
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-8">
                        <label for="inputEmail3" class="col-sm-9
                               control-label" style="white-space:nowrap;">Non Core Production Completed</label>
                     </div>
                  </div>
               </div>
               <div class="col-md-2">
...
function getJob()
{
   window.location.href = "Getjobnoncoreview?job=newjob"; 
}
...
function valicateQuery()
{
    ...
    var result = new Array();
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobnoncoreview','action'=>'ajaxqueryposing'));?>",
...
var result = new Array();
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobnoncoreview','action'=>'ajaxloadresult'));?>",
...
?>
    ...
    var result = new Array();
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobnoncoreview','action'=>'ajaxautofill'));?>",
    ...
    document.getElementById('fade').style.display='block';
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobnoncoreview','action'=>'ajaxgetnextpagedata'));?>",
