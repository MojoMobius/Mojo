               ...
               <div class="col-md-2">
                  <div class="form-group">
                     <label for="inputEmail3" class="col-sm-6
                                   control-label"><b>Non Core process</b></label>
                     <div class="col-sm-6">
                        &nbsp;
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-8">
                        <label for="inputEmail3" class="col-sm-9
                                       control-label">Non Core Production in Progress</label>
                     </div>
                  </div>
               </div>
               <div class="col-md-2">
...
function getJob()
{
        window.location.href = "Getjobnoncore?job=newjob";
}
...
function valicateQuery()
{
    ...
    var result = new Array();
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobnoncore','action'=>'ajaxqueryposing'));?>",
...
var result = new Array();
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobnoncore','action'=>'ajaxloadresult'));?>",
...
$.each( autoArr, function( key, element ) {
    ...
    var result = new Array();
        $.ajax({
            type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjobnoncore','action'=>'ajaxautofill'));?>",
    ...
    var j = 0;
        ...
        if (addnew == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjobnoncore','action'=>'ajaxsave'));?>",
        ...
        if (addnew == 'ADDNEW') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Router::url(array('controller'=>'Getjobnoncore','action'=>'ajaxnewsave'));?>",
                data: ({productionData_ely: productionData_ely,productionData_projatt: productionData_projatt, productionData: productionData, dynamicData: dynamicData, dynamicData_ely: dynamicData_ely, ProductionEntity: ProductionEntity, SequenceNumber: SequenceNumber, TimeTaken: TimeTaken, RegionId: RegionId}),
                dataType: 'text',
                async: false,
                success: function (result) {
    ...
    document.getElementById('fade').style.display='block';
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobnoncore','action'=>'ajaxgetnextpagedata'));?>",
...
//alert(seq);
    ...
    var r = confirm("Are you sure want to delete this page?");
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'Getjobnoncore','action'=>'ajaxdelete'));?>",
