...
<body>
    <header>-->
        <h1 class="header-title">
            <?= h($this->fetch('title')) ?> - Please contact technical team.
        </h1>
<!--        <span class="header-type"><?= h($this->fetch('title')) ?> - details below:<?php //echo get_class($error); ?></span>
    </header>-->
    <?php if(SHOWDETAILEDERROR=='YES') { ?>
    ...
    <!--        <p class="customize">
        ...
        <div class="error-nav">
            <?php //echo $this->element('exception_stack_trace_nav'); ?>
        </div>
    <?php } ?>
